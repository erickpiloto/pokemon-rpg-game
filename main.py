...
def carregar_jogo():
    try:
        with open("database.db", "rb") as arquivo:
            ...
            print("{} está jogando agora".format(player.nome))
            return player
    except Exception as error:
...
if __name__ == "__main__":
    print("-----------------------------")
    print("Bem vindo ao Pokemon RPG CLI")
    print("-----------------------------")
    ...
    if not player:
        ...
        print("Pronto, agora que você já possui um pokemon, enfrente seu inimigo de infância Gary")
